...
<head>
    ...
    <title>Admin Panel AgricoGroup</title>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <p class="text-white d-block">{{ Auth::user('name') }}</p>
{{--                    <p>{{ Auth::RegisteredUser()->name }}</p>--}}
                </div>
            </div>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; {{ date('Y') }} <a href="https://maksimchernyshev.com" target="_blank">Maksim
                Chernyshev</a>.</strong> All rights reserved.
    </footer>
